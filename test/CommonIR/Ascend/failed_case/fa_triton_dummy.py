...
#  task-distribution arithmetic compile cleanly to CommonIR before the full
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Dump intermediate CommonIR to PATH (default fa_triton_dummy.mlir) and exit; no device needed.")
